...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUNodeType) DeepCopyInto(out *GPUNodeType) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUNodeType.
func (in *GPUNodeType) DeepCopy() *GPUNodeType {
	if in == nil {
		return nil
	}
	out := new(GPUNodeType)
